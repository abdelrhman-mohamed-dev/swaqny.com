      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
            <h2 className="capitalize text-3xl font-bold text-gray-200 md:text-4xl">
              Swaqny empowers your teams to build a cohesive and impactful brand identity together.
            </h2>
          </div>
          {/* Planet */}
          ...
          <div className="grid overflow-hidden sm:grid-cols-2 lg:grid-cols-3 [&>*]:relative [&>*]:p-6 [&>*]:before:absolute [&>*]:before:bg-gray-800 [&>*]:before:[block-size:100vh] [&>*]:before:[inline-size:1px] [&>*]:before:[inset-block-start:0] [&>*]:before:[inset-inline-start:-1px] [&>*]:after:absolute [&>*]:after:bg-gray-800 [&>*]:after:[block-size:1px] [&>*]:after:[inline-size:100vw] [&>*]:after:[inset-block-start:-1px] [&>*]:after:[inset-inline-start:0] md:[&>*]:p-10">
            <article>
              ...
              <p className="text-[15px] text-gray-400">
                Gain real-time insights into visitor behavior with detailed metrics like page views, referral sources, and user interactions.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Unlock the power of metadata to optimize your content, improve indexing, and drive search visibility.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Improve your site's ranking with advanced tools for analyzing page performance, keywords, and optimization opportunities.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
              ...
              <p className="text-[15px] text-gray-400">
                Inject your custom scripts effortlessly for added functionality and tailored experiences.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
                <svg
                  ...
                  height={16}
                >
                  <path d="M10.284.33a1 1 0 1 0-.574 1.917 6.049 6.049 0 0 1 2.417 1.395A1 1 0 0 0 13.5 2.188 8.034 8.034 0 0 0 10.284.33ZM6.288 2.248A1 1 0 0 0 5.718.33 8.036 8.036 0 0 0 2.5 2.187a1 1 0 0 0 1.372 1.455 6.036 6.036 0 0 1 2.415-1.395ZM1.42 5.401a1 1 0 0 1 .742 1.204 6.025 6.025 0 0 0 0 2.79 1 1 0 0 1-1.946.462 8.026 8.026 0 0 1 0-3.714A1 1 0 0 1 1.421 5.4Zm2.452 6.957A1 1 0 0 0 2.5 13.812a8.036 8.036 0 0 0 3.217 1.858 1 1 0 0 0 .57-1.916 6.036 6.036 0 0 1-2.416-1.396Zm8.226 0a6.036 6.036 0 0 1-2.416 1.396 1 1 0 0 0 .57 1.916 8.036 8.036 0 0 0 3.216-1.858 1 1 0 0 0-1.37-1.454ZM15.666 9.395a1 1 0 1 1-1.946-.462 6.025 6.025 0 0 0 0-2.79 1 1 0 1 1 1.947-.462 8.026 8.026 0 0 1 0 3.714Z" />
                  <path
                    d="M4.184 7.184a4 4 0 1 1 5.657 5.657 4 4 0 0 1-5.657-5.657Z"
                    opacity=".3"
                  />
                  <path d="M5.598 9.598a1 1 0 0 1 1.415 0l.993.993.993-.993a1 1 0 0 1 1.414 1.414l-1 1A1 1 0 0 1 8 12a1 1 0 0 1-.707-.293l-1-1a1 1 0 0 1 0-1.414Z" />
                </svg>
                <span>Streamlined Setup</span>
              </h3>
              <p className="text-[15px] text-gray-400">
                Experience fast, hassle-free setup with our easy-to-use installation wizards and documentation.
              </p>
            </article>
            <article>
              <h3 className="mb-2 flex items-center space-x-2 font-medium text-gray-200">
