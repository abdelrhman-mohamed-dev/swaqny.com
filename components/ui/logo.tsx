...
export default function Logo() {
  return (
    <Link href="/" className="inline-flex items-center gap-2" aria-label="Cruip">
      ...
      <span className="uppercase text-2xl font-bold tracking-tight text-blue-600">Swaqny</span>
    </Link>
  );
}
